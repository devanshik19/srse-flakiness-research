...
public class RuntimeExceptionDao_queryForFirst_5_0_Test {
    ...
    public void testQueryForFirstSuccess() throws SQLException {
        ...
        when(mockDao.queryForFirst()).thenReturn(expectedObject);
        Object result = runtimeExceptionDao.queryForFirst();
        assertEquals(expectedObject, result);
        verify(mockDao, times(1)).queryForFirst();
    }

    @Test
    public void testQueryForFirstThrowsSQLException() throws SQLException {
        when(mockDao.queryForFirst()).thenThrow(new SQLException("Test exception"));
        RuntimeException exception = assertThrows(RuntimeException.class, () -> {
            runtimeExceptionDao.queryForFirst();
        });
