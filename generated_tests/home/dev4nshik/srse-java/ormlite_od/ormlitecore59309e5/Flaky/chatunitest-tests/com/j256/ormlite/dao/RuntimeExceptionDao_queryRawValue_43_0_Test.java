...
public class RuntimeExceptionDao_queryRawValue_43_0_Test {
    ...
    public void testQueryRawValueSuccess() throws SQLException {
        ...
        when(mockDao.queryRawValue(query, arguments)).thenReturn(expectedValue);
        long actualValue = runtimeExceptionDao.queryRawValue(query, arguments);
    ...
    public void testQueryRawValueThrowsSQLException() throws Exception {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> {
            runtimeExceptionDao.queryRawValue(query, arguments);
        });
